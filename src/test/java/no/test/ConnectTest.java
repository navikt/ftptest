...
class ConnectTest {
    ...
    void foo() throws com.jcraft.jsch.JSchException, com.jcraft.jsch.SftpException {
        ...
        javaSecureChannel.addIdentity("histark_import", bytes, null, null);

        com.jcraft.jsch.Session sftpSession = javaSecureChannel.getSession("histark_import", "sftp-histark.preprod.local", 22);
